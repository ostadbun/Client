    ...
    return (
        <div className='pt-5 flex justify-center'>
            <div className='w-6/12 h-72 shadow-xl/30 bg-[#131314] rounded-lg'>
                ...
                <p className='pt-7 pr-8 text-white'>درس نظریه زبان و ماشین‌ها به بررسی ساختارهای ریاضی برای مدل‌سازی زبان‌ها و ماشین‌های محاسباتی می‌پردازد و مفاهیمی مانند گرامرها، زبان‌های رسمی، اتوماتا و محاسبات‌پذیری را شامل می‌شود.</p>
